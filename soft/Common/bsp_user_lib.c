...
//#include "bsp.h"
    ...
    // CRC 高位字节值表
static code unsigned char s_CRCHi[] = {
...
// CRC 低位字节值表
static code unsigned char s_CRCLo[] = {
...
*********************************************************************************************************
*/
unsigned int BEBufToUint16(unsigned char *_pBuf)
{
    return (((unsigned int)_pBuf[0] << 8) | _pBuf[1]);
}
...
*********************************************************************************************************
*/
unsigned int LEBufToUint16(unsigned char *_pBuf)
{
    return (((unsigned int)_pBuf[1] << 8) | _pBuf[0]);
}
